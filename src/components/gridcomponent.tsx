...
export function GridBackgroundDemo() {
    return (
      <div className="h-[28rem] md:h-[29rem] w-full bg-navy-900  dark:bg-grid-white/[0.2] bg-grid-white/[0.2] bg-grid-custom relative flex items-center justify-center md:-mt-96 top-48  ">
